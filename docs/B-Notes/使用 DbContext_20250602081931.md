...
> 配图说明：EF Core 示例项目结构图（原始截图未随笔记归档）。
...
以下是我们在[[创建 DbContext_20250414085220|Create DbContext]]章节中创建的上下文类 `SchoolDbContext`。
